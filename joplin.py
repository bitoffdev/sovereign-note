...
def joplin_create_note(id: str, title: str, body: str, folder_id: str, created_time: datetime.datetime, updated_time: datetime.datetime) -> ParsedJoplinNote:
    return ParsedJoplinNote(
        body = f"{title}\n\n{body}",
        headers = {
            "id": id,
...
class JoplinRawStore(Store):
    ...
    def list(self, relative_path=""):
        return  [p for p in os.listdir(os.path.join(self._path, relative_path)) if os.path.isfile(p)]
